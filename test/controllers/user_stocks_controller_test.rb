...
class UserStocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_stock" do
    assert_difference('UserStock.count') do
      post user_stocks_url, params: { user_stock: { price: @user_stock.price, purchased_at: @user_stock.purchased_at, quantity: @user_stock.quantity, stock_symbol: @user_stock.stock_symbol, user_id: @user_stock.user_id } }
    end
  ...
  test "should update user_stock" do
    patch user_stock_url(@user_stock), params: { user_stock: { price: @user_stock.price, purchased_at: @user_stock.purchased_at, quantity: @user_stock.quantity, stock_symbol: @user_stock.stock_symbol, user_id: @user_stock.user_id } }
